...
{
    public class CustomerRepo : Repositories<Customers>, ICustomerRepo
    {
        ...
        public async Task<string> ForgotPasswords(string Email)
        {
            ...
            if (data != null)
            {
                data.Password = new Random().Next(111111, 999999).ToString();//Yetişirse daha mantıklı bir çözüm uygulanacak
